                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo site_url('Controle/addMoovie');?>"><i class="menu-icon icon-book"></i>Ajouter un film</a>
                                </li>

                                <li><a href="<?php echo site_url('Controle/gestionfilm');?>"><i class="menu-icon icon-book"></i>Gerer les films</a>
                                </li>
